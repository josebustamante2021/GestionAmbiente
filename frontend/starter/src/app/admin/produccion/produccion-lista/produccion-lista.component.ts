...
@Component({
  ...
  templateUrl: './produccion-lista.component.html',
  styleUrls: ['./produccion-lista.component.sass','./style.scss'],
  animations: [
...
export class ProduccionListaComponent implements OnInit {
  ...
  progHoraria(codigoAca:number){   console.log(codigoAca); 
    ...
    this.horarios=null;
    this.asignacionManualService.getProduccion(codigoAca).subscribe(
